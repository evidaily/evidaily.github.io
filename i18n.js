const translations = {
  en: {
    ...
    "status-secondary": "Space weather",
    "conclusion": "A magnitude 5.0 earthquake occurred south-southeast of Isangel, Vanuatu on 1 September 2026.",
    "viz-mag": "Magnitude scale (0–10). Marker at 5.0",
    "data-title": "Key data",
    "data-mag": "Magnitude: 5.0 (mb)",
    "data-place": "Location: 118 km SSE of Isangel, Vanuatu",
    "data-time": "Origin time: 2026-09-01 18:37:29 UTC",
    "data-depth": "Depth: approximately 122 km",
    "data-id": "Event ID: us7000tdey",
    "evidence-heading": "Evidence Chain",
    "ev-source": "Source: U.S. Geological Survey (USGS) Earthquake Hazards Program — event us7000tdey",
    "ev-method": "Method: Retrieved from the public USGS M4.5+ past-day GeoJSON feed. Magnitude type is body-wave magnitude (mb). Location and depth are the feed origin parameters at retrieval time.",
    "ev-link": "Direct event page: https://earthquake.usgs.gov/earthquakes/eventpage/us7000tdey",
    ...
    "ev-limit": "Limitation: mb can differ from later moment-magnitude revisions; depth and hypocenter may be refined.",
    ...
    "kp-time": "Sample time: 2026-09-01 19:58 UTC",
  ...
  zh: {
    ...
    "today-heading": "今日證據",
    "status-live": "即時數據",
    "status-secondary": "太空天氣",
    "conclusion": "2026年9月1日，萬那杜伊桑格爾南南東方發生規模 5.0 地震。",
    "viz-mag": "規模標尺（0–10）。標記在 5.0",
    "data-title": "關鍵數據",
    "data-mag": "規模：5.0（mb）",
    "data-place": "位置：萬那杜伊桑格爾南南東約 118 公里",
    "data-time": "發震時間：2026-09-01 18:37:29 UTC",
    "data-depth": "深度：約 122 公里",
    "data-id": "事件編號：us7000tdey",
    "evidence-heading": "證據鏈",
    "ev-source": "來源：美國地質調查局（USGS）地震災害計畫 — 事件編號 us7000tdey",
    "ev-method": "方法：從 USGS 公開「過去一日 M4.5+」GeoJSON 資料流取得。規模類型為體波規模（mb）。位置與深度為取數當下的震源參數。",
    "ev-link": "事件頁面：https://earthquake.usgs.gov/earthquakes/eventpage/us7000tdey",
    ...
    "ev-limit": "限制：mb 可能與後續矩規模修訂不同；深度與精確震源位置可能再調整。",
    "kp-conclusion": "行星地磁活動維持平靜：最新估計 Kp ≈ 0.67（低於 G1 磁暴門檻）。",
    "viz-kp": "估計 Kp（0–9）。標記在 0.67",
    "kp-data-title": "關鍵數據",
    "kp-time": "取樣時間：2026-09-01 19:58 UTC",
